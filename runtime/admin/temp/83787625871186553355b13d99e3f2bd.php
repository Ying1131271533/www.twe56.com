<?php /*a:2:{s:48:"D:\Web\www.wse.com\app\admin\view\news\save.html";i:1672383045;s:56:"D:\Web\www.wse.com\app\admin\view\public\base_layui.html";i:1672728495;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="layui-form" lay-filter="form">
        <form action="" method="post" name="example">
            <table class="layui-table" lay-size="lg" lay-skin="line">
                <thead>
                    <tr>
                        <th colspan="2">新闻添加</th>
                    </tr>
                </thead>
                <tbody>

                    <tr>
                        <td align="right"><strong>新闻分类：</strong></td>
                        <td>
                            <div style="margin-bottom:10px;">
                                <div class="layui-input-inline">
                                    <select id="layui-select" name="news_cate_id">
                    ...
                    <tr>
                        <td width="150" align="right"><strong>新闻标题：</strong></td>
                        <td>
                            <div class="layui-input-inline">
                                <input class="layui-input" type="text" name="title" placeholder="新闻名称" style="width: 400px;">
                            </div>
                            <div class="layui-input-inline">
                                <span style="color: red;">*</span> 将会成为新闻唯一标题
                            </div>
                        </td>
                    </tr>
                    <tr>
