<?php /*a:2:{s:56:"D:\Web\www.wse.com\app\admin\view\about_cate\update.html";i:1672389588;s:56:"D:\Web\www.wse.com\app\admin\view\public\base_layui.html";i:1672799469;}*/ ?>
<!DOCTYPE html>
<html>
...
<script>
    ...
    layui.use(['form', 'layer'], function () {
        var form = layui.form,
            layer = layui.layer;
        // 获取数据
        var data = ajax_read('/about_cate');
        console.log(data);
        // 表单赋值
        form.val("form", data);
        // 更新数据
        layui_ajax_update(form, '/about_cate');
    });
</script>
