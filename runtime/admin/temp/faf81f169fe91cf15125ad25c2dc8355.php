<?php /*a:2:{s:52:"D:\Web\www.wse.com\app\admin\view\product\index.html";i:1673338436;s:56:"D:\Web\www.wse.com\app\admin\view\public\base_layui.html";i:1672799469;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="layui-fluid">
  <div class="layui-row layui-col-md-offset0" style="margin-bottom:20px;">
    <div class="layui-col-md9">
      <a href="/view/product_save" class="layui-btn layui-btn-danger">添加产品</a>
    </div>
  </div>
  <div class="layui-form">
    ...
    <div class="layui-input-inline">
      <input class="layui-input" type="text" name="title" value="" placeholder="产品标题" id="titleReload">
    </div>
    <div class="layui-input-inline">
  ...
  layui.use(['jquery', 'layer', 'table', 'flow', 'form'], function () {
    ...
    var ins1 = table.render({
      ...
      , cols: [[ //表头
        ...
        , { field: 'title', title: '产品标题', width: 400 }
    ...
    table.on('tool(table_akali)', function (obj) {
      ...
      if (layEvent === 'update') {
        layer.open({
          type: 2,
          title: '产品更新 ID：' + data.id,
          content: '/view/product_update?id=' + data.id,
          shadeClose: true,
          shade: [0.8, '#000000'],
          area: ['1280px', '600px'],
        });
        ...
        layui_form_delete(this, '/product/' + data.id);
      }
    });
  });
