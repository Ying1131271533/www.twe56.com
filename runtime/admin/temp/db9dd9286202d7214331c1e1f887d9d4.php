<?php /*a:2:{s:52:"D:\Web\www.wse.com\app\admin\view\article\index.html";i:1672383045;s:56:"D:\Web\www.wse.com\app\admin\view\public\base_layui.html";i:1672799469;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="layui-fluid">
  <div class="layui-row layui-col-md-offset0" style="margin-bottom:20px;">
    <div class="layui-col-md9">
      <a href="/view/article_save" class="layui-btn layui-btn-danger">添加文章</a>
    </div>
  </div>
    ...
    table.on('tool(table_akali)', function (obj) {
      ...
      if (layEvent === 'update') {
        layer.open({
          type: 2,
          title: '文章更新',
          content: '/view/article_update?id=' + data.id,
          shadeClose: true,
          shade: [0.8, '#000000'],
          area: ['1280px', '600px'],
        });
        ...
        layui_form_delete(this, '/article/' + data.id);
      }
    });
  });
