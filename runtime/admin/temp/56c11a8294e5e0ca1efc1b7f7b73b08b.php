<?php /*a:2:{s:50:"D:\Web\www.wse.com\app\admin\view\slide\index.html";i:1672625006;s:56:"D:\Web\www.wse.com\app\admin\view\public\base_layui.html";i:1672383045;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="layui-fluid">
  <div class="layui-row layui-col-md-offset0" style="margin-bottom:20px;">
    <div class="layui-col-md9">
      <a href="/view/slide_save" class="layui-btn layui-btn-danger">添加</a>
    </div>
  </div>
...
<script type="text/html" id="cateTpl">
  <p>{{ d.category.title }}</p>
</script>

<script type="text/html" id="imageTpl">
  {{#  layui.each(d.imgs, function(index, item){ }}
  <img src="{{ item }}" width="70" style="cursor:pointer;" onclick="open_img(this)" />
  {{#  }); }}
</script>
  ...
  layui.use(['jquery', 'layer', 'table', 'flow', 'form'], function () {
    ...
    var ins1 = table.render({
      ...
      , cols: [[ //表头
        ...
        , { field: 'category.title', title: '分类', width: 100, templet: '#cateTpl' }
    ...
    table.on('tool(table_akali)', function (obj) {
      ...
      if (layEvent === 'update') {
        layer.open({
          type: 2,
          title: '更新',
          content: '/view/slide_update?id=' + data.id,
          shadeClose: true,
          shade: [0.8, '#000000'],
          area: ['1280px', '600px'],
        });
        ...
        layui_form_delete(this, '/slide/' + data.id);
      }
    });
  });
