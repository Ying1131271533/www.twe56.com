<?php /*a:2:{s:50:"D:\Web\www.wse.com\app\admin\view\role\update.html";i:1671093847;s:56:"D:\Web\www.wse.com\app\admin\view\public\base_layui.html";i:1672036114;}*/ ?>
<!DOCTYPE html>
<html>
...
<script>
    layui.use(['form', 'layer'], function () {
        ...
        // 表单赋值
        var data = ajax_read('/role');
        form.val("form", data);
        // 取值
        // data = form.val("form");

        // 更新数据
        layui_ajax_update(form, '/role');
    });
</script>
