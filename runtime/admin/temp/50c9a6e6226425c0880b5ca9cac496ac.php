<?php /*a:2:{s:54:"D:\Web\www.wse.com\app\admin\view\about_cate\save.html";i:1672389382;s:56:"D:\Web\www.wse.com\app\admin\view\public\base_layui.html";i:1672383045;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="layui-input-inline">
                                <span style="color: red;">*</span>  例如：新手指南
                            </div>
                        </td>
                    </tr>
                    <tr>
...
<script>
    layui.use(['form', 'layer'], function () {
        ...
        var form = layui.form;
        // 保存
        layui_ajax_save(form, '/about_cate', '/view/about_cate_index');
    });
</script>
