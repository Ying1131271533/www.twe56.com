<?php /*a:2:{s:55:"D:\Web\www.wse.com\app\admin\view\about_cate\index.html";i:1672389548;s:56:"D:\Web\www.wse.com\app\admin\view\public\base_layui.html";i:1672799469;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="layui-fluid">
    <div class="layui-row layui-col-md-offset0" style="margin-bottom:20px;">
        <div class="layui-col-md9">
            <a href="/view/about_cate_save" class="layui-btn layui-btn-danger">添加分类</a>
        </div>
    </div>
...
<script>
    ...
    let artcileCateList = ajax_list('/about_cate');
    ...
    function update(id) {
        ...
        layer.open({
            ...
            shade: [0.8, '#000000'],
            area: ['700px', '500px'],
            content: "/view/about_cate_update?id=" + id,
        });
    }

    function del(obj, id) {
        layui_form_delete(obj, '/about_cate/' + id);
    }
</script>
