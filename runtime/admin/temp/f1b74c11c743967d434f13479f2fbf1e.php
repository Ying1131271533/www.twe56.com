<?php /*a:2:{s:50:"D:\Web\www.wse.com\app\admin\view\admin\index.html";i:1672383045;s:56:"D:\Web\www.wse.com\app\admin\view\public\base_layui.html";i:1672799469;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="layui-fluid">
  <div class="layui-row layui-col-md-offset0" style="margin-bottom:20px;">
    <div class="layui-col-md9">
      <a href="/view/admin_save" class="layui-btn layui-btn-danger">添加管理员</a>
    </div>
  </div>
  ...
  layui.use(['jquery', 'layer', 'table', 'flow', 'form'], function () {
    ...
    var ins1 = table.render({
      ...
      , cols: [[ //表头
        ...
        , { field: 'username', title: '管理员名称', width: 120 }
        , { field: 'real_name', title: '真实姓名', width: 120 }
        , { field: 'phone', title: '手机', width: 150 }
        , { field: 'wechat', title: '微信', width: 150 }
        , { field: 'login_number', title: '登录次数', width: 120, sort: true, templet: '#loginNumberTpl' }
    ...
    table.on('tool(table_akali)', function (obj) {
      ...
      if (layEvent === 'update') {
        layer.open({
          type: 2,
          title: '管理员更新',
          content: '/view/admin_update?id=' + data.id,
          shadeClose: true,
          shade: [0.8, '#000000'],
          area: ['1000px', '600px'],
        });
        ...
        layer.open({
          type: 2,
          title: '修改密码',
          content: '/view/admin_password?id=' + data.id,
          shadeClose: true,
          shade: [0.8, '#000000'],
          area: ['500px', '300px'],
        });
        ...
        layui_form_delete(this, '/admin/' + data.id);
      }
    });
  });
